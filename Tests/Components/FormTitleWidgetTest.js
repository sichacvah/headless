...
import FormTitleWidget from '../../App/Components/FormTitleWidget'

const wrapper = shallow(<FormTitleWidget />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('FormTitleWidget Component')) // That the Component Text is included
})
