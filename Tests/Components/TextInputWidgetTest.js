...
import TextInputWidget from '../../App/Components/TextInputWidget'

const wrapper = shallow(<TextInputWidget />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('TextInputWidget Component')) // That the Component Text is included
})
