...
import FormWidget from '../../App/Components/FormWidget'

const wrapper = shallow(<FormWidget />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('FormWidget Component')) // That the Component Text is included
})
