...
import LinkWidget from '../../App/Components/LinkWidget'

const wrapper = shallow(<LinkWidget />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('LinkWidget Component')) // That the Component Text is included
})
