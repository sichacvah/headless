...
import SelectWidget from '../../App/Components/SelectWidget'

const wrapper = shallow(<SelectWidget />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('SelectWidget Component')) // That the Component Text is included
})
