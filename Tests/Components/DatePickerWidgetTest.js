...
import DatePickerWidget from '../../App/Components/DatePickerWidget'

const wrapper = shallow(<DatePickerWidget />)
...
test('component structure', t => {
  ...
  t.true(wrapper.children().first().containsMatchingElement('DatePickerWidget Component')) // That the Component Text is included
})
